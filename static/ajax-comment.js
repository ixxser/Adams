(function ($) {
    ...
    $(function(){
            ...
            if ($(".grid-3").hasClass("music-left")) {
                $(".grid-9").removeClass("jAudio_right")
            }
            $('.jAudio--player').toggleClass('music-off');
            });
    });

    $(".likespd").click(function () {
    ...
    var wp_url = js_url.substr(0, js_url.indexOf()),
